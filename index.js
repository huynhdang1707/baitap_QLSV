...
function themNv(){
    ...
    var nv = new NhanVien(_taiKhoan,_tenNhanVien,_email,_matKhau,_ngayLam,_luongCoBan,_chucVu,_gioLam);
    // tạo object
    // var nv = {
    //     taiKhoan: _taiKhoan,
    //     ten: _tenNhanVien,
...
function suaNv(id) {
  ...
  function capNhatNV() {
    ...
    var sinhVien = new NhanVien(_ma, _ten, _email, _matKhau, _toan, _van);
  
    dssv[viTriSua] = sinhVien;
